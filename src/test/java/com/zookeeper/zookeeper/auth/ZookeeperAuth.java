package com.zookeeper.zookeeper.auth;
...
public class ZookeeperAuth implements Watcher {
	...
	public static void main(String[] args) throws Exception {
		...
		testAuth.createConnection(Constant.CONNECT_ADDR,2000);
	...
	static void getDataByBadAuthentication() {
		...
		try {
			ZooKeeper badzk = new ZooKeeper(Constant.CONNECT_ADDR, 2000, null);
			//授权
	...
	static void getDataByNoAuthentication() {
		...
		try {
			System.out.println(prefix + "获取数据：" + PATH);
			ZooKeeper nozk = new ZooKeeper(Constant.CONNECT_ADDR, 2000, null);
			Thread.sleep(2000);
